...
UIScreen::UIScreen(int out_w, int out_h):out_w_(out_w),out_h_(out_h){};

void UIScreen::SetSize(int out_w, int out_h){
	out_w_ = out_w; out_h_ = out_h;
}

UIScreen::TextBox::TextBox(SDL_Renderer* renderer, const char* text, TTF_Font* font, const SDL_Color& color){
	Update(renderer, text, font, color, true);
}

void UIScreen::TextBox::Update(SDL_Renderer* renderer, const char* text, TTF_Font* font, const SDL_Color& color, bool f){
...
void UIScreen::TextBox::Draw(SDL_Renderer* renderer, const SDL_Rect& rect){
